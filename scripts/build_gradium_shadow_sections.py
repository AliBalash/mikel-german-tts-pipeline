...
DEFAULT_CACHE_DIR = "artifacts/audio/gradium_entry_cache"
DEFAULT_OUTPUT_DIR = "artifacts/audio/gradium_sections"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--cache-dir", default=DEFAULT_CACHE_DIR, help="Directory for cached entry WAV files.")
    ...
    parser.add_argument("--voice", default="Maximilian", help="Gradium voice name.")
