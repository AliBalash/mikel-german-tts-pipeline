...
def default_output_dir(output_root: Path, provider_name: str) -> Path:
    return output_root / provider_name
...
def resolve_config(args) -> ResolvedConfig:
    ...
    output_dir = Path(args.output_dir) if args.output_dir else default_output_dir(output_root, provider_name)
